...
3. Acesse `src/pages/index.html` pelo endereço fornecido pelo servidor.

O servidor local é recomendado porque as páginas usam JavaScript e caminhos iniciados em `/src`. Abrir os arquivos diretamente pode fazer alguns links ou scripts falharem, dependendo do navegador.
...
Arquivos: `src/pages/index.html`, `src/scripts/index.js` e `src/styles/index.css`.
...
| --- | --- |
| `src/pages/index.html` | Estrutura do dashboard e navegação principal. |
